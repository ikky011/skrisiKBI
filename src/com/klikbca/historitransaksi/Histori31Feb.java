...
public class Histori31Feb {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("Histori31februari"));
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFHistori31februari");
	}
	...
	public void PilihJenisTransaksi() throws Exception {
		...
		List<WebElement> rdBtn =  driver.findElements(By.name("value(periode)"));
