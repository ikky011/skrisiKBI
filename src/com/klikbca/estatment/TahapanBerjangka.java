...
public class TahapanBerjangka {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("TahapanBerjangka"));
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFTahapanBerjangka");
	}
	...
	@Test(priority = 3)
	public void KlikEstatment() throws Exception {
	...
	@Test(priority = 4)
	public void KlikTahapanBerjangka() throws Exception {
