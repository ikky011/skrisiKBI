...
public class TabunganDanGiro {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		String path = (prop.getProperty("TabunganDanGiro"));// conver webdriver object to TakeScreenshot
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFTabunganDanGiro");
	}
	...
	@Test(priority = 3)
	public void KlikEStatement() throws Exception {
		driver.switchTo().frame(driver.findElement(By.name("menu")));
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td[2]/table/tbody/tr[11]/td/a/font/b")).click();
		takeSnapShot(driver);

	}
	@Test(priority = 4)
	public void KlikTabunganDanGiro() throws Exception {
