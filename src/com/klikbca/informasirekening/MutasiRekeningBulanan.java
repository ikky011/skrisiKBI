...
public class MutasiRekeningBulanan {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("InformasiRekeningMutasiBulanan"));	// conver webdriver object to TakeScreenshot
		...
		st.path = path;
		st.outdir =  prop.getProperty("PDFInformasiRekeningMutasiBulanan");
	}
