...
public class InformasilSaldoSukses {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("InformasiRekeningInformasiSaldo"));		
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFInformasiRekeningInformasiSaldo");		
	}
