...
public class MutasiRekeningBulananBulanSebelumnya {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("InformasiRekeningMutasiBulananBulanSebelumnya"));	// conver webdriver object to TakeScreenshot
		...
		st.path = path;
		st.outdir =  prop.getProperty("PDFInformasiRekeningMutasiBulananBulanSebelumnya");
	}
	...
	public void KlikInformasiRekening() throws Exception {
		...
		driver.findElement(By.xpath("/html/body/table/tbody/tr/td[2]/table/tbody/tr[9]/td/a/font/b")).click();
		takeSnapShot(driver);
	}
	...
	@Test(priority = 5)
	public void DropDownPilihBulanAwal() throws Exception {
		driver.switchTo().defaultContent();
		driver.switchTo().frame(driver.findElement(By.name("atm")));
		List oRdb = driver.findElements(By.name("value(r1)"));
		boolean bvalue = false;
		bvalue = ((WebElement) oRdb.get(0)).isSelected();
		if (bvalue){
			((WebElement) oRdb.get(1)).click();
		}else{
			((WebElement) oRdb.get(0)).click();
		}
	...
	public void PilihHariDanBulan() throws Exception {
		driver.switchTo().defaultContent();
		driver.switchTo().frame(driver.findElement(By.name("atm")));
		Select DSelect = new Select(driver.findElement(By.id("x")));
