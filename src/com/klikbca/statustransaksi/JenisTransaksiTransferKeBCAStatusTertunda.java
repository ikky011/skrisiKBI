...
public class JenisTransaksiTransferKeBCAStatusTertunda {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("StatusJenisTransaksiTransferKeBCATertunda"));
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFStatusJenisTransaksiTransferKeBCATertunda");
	}
	...
	@Test(priority = 5)
	public void PilihStatusTransaksi() throws Exception {

		Select StatusSelect = new Select(driver.findElement(By.id("ststxn")));
