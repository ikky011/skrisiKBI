...
public class SemuaPertransaksiDibuat {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("StatusSemuaPerTransaksiDibuat"));
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFStatusSemuaPerTransaksiDibuat");
	}
	...
	@Test(priority = 4)
	public void KlikLanjut() throws Exception {
