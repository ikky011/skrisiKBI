...
public class InformasiSaldoBerhasil {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("InformasiKartuKreditInformasiSaldo"));
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFInformasiKartuKreditInformasiSaldo");
	}
	...
	@Test(priority = 4)
	public void KlikInformasiSaldo() throws Exception {
	...
	@Test(priority = 5)
	public void PilihNoCustomer() throws Exception {
