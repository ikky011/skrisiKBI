...
public class TransaksiBerhasil {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("InformasiKartuKreditTransaksi"));
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFInformasiKartuKreditTransaksi");
	}
	...
	@Test(priority = 4)
	public void KlikTransaksi() throws Exception {
