...
public class LoginUserNameHanyaNumerik {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("UsernameNumerik"));	// conver webdriver object to TakeScreenshot
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFUsernameNumerik");
		// }
	}
	...
	public void inputform() throws Exception {
		driver.findElement(By.id("user_id")).sendKeys("12345678910");
