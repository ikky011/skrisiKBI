...
public class LoginPinAlphabet {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("LoginPinAlphabet"));	// conver webdriver object to TakeScreenshot
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFLoginPinAlphabet");
	}
	...
	/*
	 * @Test (priority = 1) public void masuk() throws Exception {
	 * driver.findElement(By.xpath(
	 * "/html/body/table[2]/tbody/tr/td[2]/div/form/table/tbody/tr[12]/td/input"
	 * )).click(); takeSnapShot(driver); }
	 */
