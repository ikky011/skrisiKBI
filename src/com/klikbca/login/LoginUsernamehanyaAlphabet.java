...
public class LoginUsernamehanyaAlphabet {
	...
	public static void takeSnapShot(WebDriver webdriver) throws Exception {
		...
		// conver webdriver object to TakeScreenshot
		String path = (prop.getProperty("UsernameAlphabet"));	// conver webdriver object to TakeScreenshot
		...
		st.path = path;
		st.outdir = prop.getProperty("PDFUsernameAlphabet");	}
	...
	public void inputform() throws Exception {
		driver.findElement(By.id("user_id")).sendKeys("rizkygantengg");
